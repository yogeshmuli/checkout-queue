...
const tabs = [
  ...
  { label: 'Config', path: configurationPaths[1], preserveStoreId: true },
  { label: 'Zones', path: configurationPaths[2], preserveStoreId: true },
  { label: 'Studios', path: configurationPaths[3], preserveStoreId: true },
...
export function ConfigurationTabs() {
  ...
  return (
    <nav className="mb-6 overflow-x-auto rounded-lg border border-line bg-white" aria-label="Trial configuration">
