...
import { Field } from '../../../app/common/FormAndStatePrimitives.jsx';
    ...
    <main className="min-h-screen animate-fadeIn px-4 py-5">
      <section className="mx-auto max-w-md animate-slideUp">
        ...
        <form className="mt-5 space-y-4 rounded-lg bg-white p-5 text-ink shadow-soft" onSubmit={submitLookup}>
          ...
          <Link to="/app/customer/create" className="block rounded-lg bg-brand-blush px-3 py-2 text-center text-sm font-medium text-brand-red">
            Create new token
          </Link>
        </form>
      </section>
