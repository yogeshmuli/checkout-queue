...
import { createStore, deleteStore, listStores, updateStore } from '../../../../api/checkout/storeApi.js';
              ...
              >
                <div>
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    <ResourceLink to={`/app/checkout/admin/sections?store_id=${store.id}`} label="Sections" />
                    <ResourceLink to={`/app/checkout/admin/counters?store_id=${store.id}`} label="Counters" />
                    <ResourceLink to={`/app/checkout/admin/staff?store_id=${store.id}`} label="Staff" />
                    <ResourceLink to={`/app/checkout/admin/queue?store_id=${store.id}`} label="Queue" />
                    <ResourceLink to={`/app/checkout/admin/calendar?store_id=${store.id}`} label="Calendar" />
                    <ResourceLink to={`/app/checkout/admin/ml?store_id=${store.id}`} label="ML" />
                    <ResourceLink to={`/app/checkout/admin/store-config?store_id=${store.id}`} label="Config" />
                  </div>
                </div>
