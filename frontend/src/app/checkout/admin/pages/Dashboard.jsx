...
function HistoryView({ analytics }) {
  ...
  return (
    <div className="space-y-6">
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <MetricTile label="Check-ins " value={rangeTotals.checkIns} />
        <MetricTile label="Completed " value={rangeTotals.completed} />
        <MetricTile label="Cancelled " value={rangeTotals.cancelled} tone="rose" />
