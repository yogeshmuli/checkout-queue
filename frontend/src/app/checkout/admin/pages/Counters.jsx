...
import { createCounter, deleteCounter, listCounters, updateCounter } from '../../../../api/checkout/counterApi.js';
                ...
                >
                  <div>
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      {section ? <ResourceLink to={`/app/checkout/admin/sections?store_id=${section.store_id}`} label="Store sections" /> : null}
                      <ResourceLink to={`/app/checkout/admin/counters?section_id=${counter.section_id}`} label="Section counters" />
                      <ResourceLink to={`/app/checkout/admin/staff?counter_id=${counter.id}`} label="Staff" />
                      <ResourceLink to={`/app/checkout/admin/queue?counter_id=${counter.id}`} label="Queue" />
                    </div>
                  </div>
