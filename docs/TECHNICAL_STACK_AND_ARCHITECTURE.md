...
| Next-soon notification scan | Every 1 minute | Send one mock SMS when Checkout/Trial tokens reach each store's configured next-soon lane position |
